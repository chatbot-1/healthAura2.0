          ...
          <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
              ...
              <p className="text--para">
                ...
                us as one of the best publics hospitals in the Nation as #1 in
                texas. Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Porro consequatur unde, nihil tenetur laborum consectetur.
              </p>
              <p className="text--para mt-[30px]">
                ...
                sit amet, consectetur adipisicing elit. Dolores, vitae. Debitis
                architecto eaque aut vitae!
              </p>
